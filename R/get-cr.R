                     ...
                     summarize = FALSE )
{
  ...
  if ( summarize ) {
    ...
    plot( density( CR$cr, na.rm = TRUE ), main = "CR (raw)" )
    plot( density( CR$cr_w, na.rm = TRUE ), main = "CR Winsorized" )
    plot( density( CR$cr_z, na.rm = TRUE ), main = "CR Standardized (Z)" )
    plot( density( CR$cr_p, na.rm = TRUE ), main = "CR Percentile" )
  }
