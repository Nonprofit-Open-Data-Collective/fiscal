...
#'
#' @format A data frame with 10,000 rows. The dataset includes
...
#'
#'   ## BMF classification and geography (as returned by
#'   `retrieve_efile_data( include_bmf = TRUE )`):
#'
...
#' organization with [deduplicate()] before 10,000 organizations with an NTEE
#' code and non-negative total revenue were sampled. The sample includes a mix of
#' full 990 and 990EZ filers; see `RETURN_TYPE` to distinguish them.
#'
