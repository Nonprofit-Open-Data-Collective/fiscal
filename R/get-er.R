                     ...
                     summarize = FALSE )
{
  ...
  if ( summarize ) {
    ...
    plot( density( ER$er, na.rm = TRUE ), main = "ER (raw)" )
    plot( density( ER$er_w, na.rm = TRUE ), main = "ER Winsorized" )
    plot( density( ER$er_z, na.rm = TRUE ), main = "ER Standardized (Z)" )
    plot( density( ER$er_p, na.rm = TRUE ), main = "ER Percentile" )
  }
