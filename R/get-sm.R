                     ...
                     summarize = FALSE )
{
  ...
  if ( summarize ) {
    ...
    plot( density( SM$sm, na.rm = TRUE ), main = "SM (raw)" )
    plot( density( SM$sm_w, na.rm = TRUE ), main = "SM Winsorized" )
    plot( density( SM$sm_z, na.rm = TRUE ), main = "SM Standardized (Z)" )
    plot( density( SM$sm_p, na.rm = TRUE ), main = "SM Percentile" )
  }
